...
- The opt-in projected-gap replay can now submit selected gameplay transform-gap families through
  ...
  cloth/banner family, the 6E10 indexed stride-10 stage/building model family, and the 83BD
  indexed stride-12 weighted officer/character family.
...
- Replay promoted projected-transform gameplay families as standard
  ...
  `c[13+a0]..c[15+a0]` skin block and `c9..c12` projection block. The
  `45C4DDDAAA10F75F / 7703E4142DFBD4D4` stride-9 family is promoted behind an exact layout gate
  for its shared `c4..c6` skin block and `c0..c3` projection block. The
  `6B722207E8ECA2B6 / D10452A3E31F9C61` stride-9 attrs-4 family is promoted through its exact
  ...
  projection block. The `83BD204594EECAB8 / D10452A3E31F9C61` stride-12 attrs-6 family is promoted
  through its exact weighted officer/character layout, two explicit weights plus the implicit third
