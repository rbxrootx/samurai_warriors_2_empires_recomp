...
# Codegen target - run 'cmake --build . --target samurai_warriors_2_empires_codegen'
# Uses the manifest to drive codegen for all modules (entrypoint + DLLs).
add_custom_target(samurai_warriors_2_empires_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/samurai_warriors_2_empires_manifest.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for samurai_warriors_2_empires"
    VERBATIM
)
